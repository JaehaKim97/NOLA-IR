...
from utils.common import calculate_psnr_list, suppress_stdout, wavelet_reconstruction
...
class DiffBIROnlyPipeline(BasePipeline):
    ...
    def prepare_all(self):
        attrs = ["res_model", "vae", "text_encoder", "cldm", "det_model", "val_dataloader"]
        if not self.args.eval_only:
    ...
    def evaluate(self):
        ...
        for batch in self.val_dataloader:
            ...
            gt, res, size = self.accelerator.gather_for_metrics((self.gt, res, size))
